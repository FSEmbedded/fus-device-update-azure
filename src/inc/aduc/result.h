...
/**
 * @brief Macros to convert FSUPDATE Handler results to extended result code values.
 * Extended error codes begin with 0x320#####
 */
static inline ADUC_Result_t MAKE_ADUC_FSUPDATE_HANDLER_EXTENDEDRESULTCODE(const int32_t value)
{
    return MAKE_ADUC_CONTENT_HANDLER_EXTENDEDRESULTCODE (ADUC_CONTENT_HANDLER_EXTERNAL, value);
}
...
#define ADUC_ERC_FSUPDATE_HANDLER_DOWNLOAD_BAD_FILE_ENTITY \
    MAKE_ADUC_SWUPDATE_HANDLER_EXTENDEDRESULTCODE(0x103)

#define ADUC_ERC_FSUPDATE_HANDLER_DOWNLOAD_FAILURE_UNKNOW_UPDATE_VERSION \
    MAKE_ADUC_SWUPDATE_HANDLER_EXTENDEDRESULTCODE(0x104)
#define ADUC_ERC_FSUPDATE_HANDLER_DOWNLOAD_FAILURE_CREATE_FAILED_UPDATE_VERSION \
    MAKE_ADUC_SWUPDATE_HANDLER_EXTENDEDRESULTCODE(0x105)
...
#define ADUC_ERC_FSUPDATE_HANDLER_INSTALL_FAILURE_CANNOT_OPEN_WORKFOLDER \
    MAKE_ADUC_SWUPDATE_HANDLER_EXTENDEDRESULTCODE(0x204)
...
// Exit code from child process. (0x32001000 + exitCode)
